...
def generate_ai_interpretation(metrics: dict) -> dict:
    ...
    system_prompt = (
        ...
        "Confidence Score Vetting Scale (CRITICAL CAPPING LIMIT):\n"
        "- The maximum allowed confidence score for any planetary candidate is 90.0%. Never output a confidence score greater than 90.0% (photometry alone cannot exceed 90.0% because we lack centroid motion checks, nearby star contamination, and Gaia cross-matching).\n"
