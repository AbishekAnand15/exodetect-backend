...
def generate_ai_interpretation(metrics: dict) -> dict:
    ...
    system_prompt = (
        ...
        "- Use the following scientific phrasing: 'consistent with a planetary origin and shows no evidence for an eclipsing binary scenario' instead of 'likely a single planet candidate rather than an eclipsing binary system'.\n"
